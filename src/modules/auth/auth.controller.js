...
let AuthController = class AuthController {
    ...
    async validarAdminLogin(body) {
        ...
        if (!senhaOk)
            throw new common_1.ForbiddenException("Senha incorreta");
...
__decorate([
    (0, common_1.Post)("validar-admin"),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "validarAdminLogin", null);
