...
let MercadoPagoWebhookService = class MercadoPagoWebhookService {
    validateSignature(signature, rawBody, secret) {
        if (!signature) {
            throw new common_1.UnauthorizedException("Assinatura ausente");
        }
        ...
        const expected = crypto
            ...
            .digest("hex");
        if (expected !== v1) {
            throw new common_1.UnauthorizedException("Assinatura não confere");
        }
    }
};
exports.MercadoPagoWebhookService = MercadoPagoWebhookService;
exports.MercadoPagoWebhookService = MercadoPagoWebhookService = __decorate([
