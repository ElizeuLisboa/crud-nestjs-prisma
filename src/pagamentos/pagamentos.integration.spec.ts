...
describe("PagamentosService Integration", () => {
  ...
  beforeEach(async () => {
    ...
    await prismaService.produto.createMany({
      data: [
        { title: "Produto 1", price: 10.0, description: "desc", image: "", estoque: 100 },
        { title: "Produto 2", price: 20.0, description: "desc", image: "", estoque: 50 },
        { title: "Produto 3", price: 30.0, description: "desc", image: "", estoque: 25 },
        { title: "Produto 4", price: 40.0, description: "desc", image: "", estoque: 10 },
        { title: "Produto 5", price: 50.0, description: "desc", image: "", estoque: 5 },
      ],
    });
  });
