...
const create_sangria_dto_1 = require("./dto/create-sangria.dto");
const common_2 = require("@nestjs/common");
let AuditoriaController = class AuditoriaController {
    constructor(auditoriaService) {
        this.auditoriaService = auditoriaService;
    }
    async registrar(operadorId, autorizadoPor, dto, req) {
        const user = req.user;
        return this.auditoriaService.criar(Number(operadorId), autorizadoPor ? Number(autorizadoPor) : null, user.empresaId, dto);
    }
};
exports.AuditoriaController = AuditoriaController;
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Query)("operadorId")),
    __param(1, (0, common_1.Query)("autorizadoPor")),
    __param(2, (0, common_1.Body)()),
    __param(3, (0, common_2.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, create_sangria_dto_1.CreateAuditoriaDto, Object]),
    __metadata("design:returntype", Promise)
], AuditoriaController.prototype, "registrar", null);
